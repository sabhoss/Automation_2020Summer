...
public class TestNG_driven_mortgage {
    ...
    public void setDriver() throws IOException, BiffException {
        ...
        readableFile = Workbook.getWorkbook(new File("src/main/resources/Mortgage sheet.xls"));
        ...
        writableFile = Workbook.createWorkbook(new File("src/main/resources/Mortgage sheet_Results.xls"),readableFile);
